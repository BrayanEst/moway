...
use App\Http\Controllers\ConductorApiController;
...
#Conductor
    //mostrar conductor
    Route::get('conductor',[ConductorApiController::class,'index']);
    //editar conductor
    Route::put('conductor/{id}',[ConductorApiController::class,'update']);
    //crear conductor
    Route::post('/register/conductor',[ConductorApiController::class,'store']);
    //elimiinar conductor
    Route::delete('conductor/{id}',[ConductorApiController::class,'destroy']);
...
#Consultas
    ...
    Route::get('conductor_recorrido/{id}',[ConductorApiController::class,'Conductor_Recorrido']);

    Route::get('recorrido_consulta/{id}',[RecorridoApiController::class,'ConsultaRecorridos_rutas_empresa']);

    Route::get('recorrido_consulta_imagen_ruta_empresa/{id}/{id_recorrido}',[RecorridoApiController::class,'ConsultaRecorridos_Imagen_ruta_empresa']);

    Route::get('recorrido_horario/{id}',[RecorridoApiController::class,'Recorrido_Horario']);

    Route::get('recorrido_parada/{id}',[RecorridoApiController::class,'Recorrido_Parada']);
